                                                    ...
                                                    <div class="row" style="margin: auto;">
                                                        <div class="col-5 ps-0" style="align-content: center;">
                                                            ...
                                                            <div class="d-flex ribbon7 ms-1" style="background-color: #e7e7e7 !important;">
                                                                <span class="h6 font-weight-medium mb-1 pt-1">Cible Annuel:</span>
                                                            </div>
                                    ...
                                    <div class="col-12" style="align-content: center; padding-left: 0;">
                                        <div class="row">   
                                            ...
                                            <div class="col-4">
                                                ...
                                                <div class="d-flex ribbon7 ms-1" style="background-color: #e7e7e7 !important;">
                                                    <span class="h5 font-weight-medium mb-1 pt-1" id="">Cible Annuel:</span>
                                                </div>
            ...
            $.ajax({
                ...
                success: function (response) 
                {
                    ...
                    if (response.type == 'nd') 
                    {
                        ...
                        $('#cibleName').text('Cible ' + (pMapping[month] + ' :' || '/'));
                        $('#simuND').text('La simulation ' + pMapping[month] + ' :' || '/');
                    ...
                    else 
                    {
                        ...
                        $('#cibleNameCH').text('Cible ' + (pMapping[month] + ' :' || '/'));
                        $('#simuCH').text(('La simulation ' + pMapping[month] + ' :' || '/'));
