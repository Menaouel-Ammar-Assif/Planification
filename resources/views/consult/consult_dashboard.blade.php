...
<style>
    ...
    #fixedButton:hover {
        ...
        .zoomed {
            zoom: 150%; /* Adjust the zoom level as needed */
        }
                                ...
                                <div class="row">
                                                                                                                ...
                                                                                                                <tbody>
                                                                                                                    @foreach($obj->SousObjectif as $sousObj)
                                                                                                                        ...
                                                                                                                        <tr id="{{ $action->id_act_cop_dr}}" style="background-color: #f7f7f7">
                                                                                                                            ...
                                                                                                                            <td>{{ date('d/m/Y', strtotime($action->df)) }}</td>
                                                                                                                            <td>
                                                                                                                                @foreach ($directionsDr as $item)
                                                                                                                                    @if ($item->id_dir == $action->id_dr)
                                                                                                                                        {{$item->lib_dir}}
                                                                                                                                    @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <a type="button" id="fixedButton" class="btn btn-primary px-4 float-end" href="{{ route('Model.Indic') }}">Modèle de fiche d'indicateur <span class="bg-white" style="width: fit-content; display: block; padding: 6px; border-radius: 35%; margin-left: 20px;"><i class="fa-solid fa-file-pdf fa-2xl text-danger"></i></span> </a>
                                            ...
                                            <div class="btn-group" role="group">
                                                <button type="button" class="btn btn-primary ms-4 dropdown-toggle" style="width: fit-content; border-radius: 5%;" data-bs-toggle="dropdown" aria-expanded="false">
                                                    Information des donneés <span class="bg-white" style="width: fit-content; display: block; padding: 6px; border-radius: 35%; margin-left: 65px;"><i class="fa-solid fa-file-pdf fa-2xl text-danger"></i></span>
                                                </button>
                                                <ul class="dropdown-menu p-0">
                                                    <li><a class="dropdown-item bg-success text-white font-weight-medium btn" href="{{ route('Model.SynthS1') }}">1er Semestre 2024</a></li>
                                                    <li><a class="dropdown-item bg-success text-white font-weight-medium btn" href="{{ route('Model.SynthT1') }}">1er Trimestre 2024</a></li>
                                                </ul>
                                            </div>
        ...
        $('#DCselect').on('change', function ()
        {
                ...
                success: function(response)
                {
                    ...
                    response.actionsDc.forEach(function(action)
                    {
                            ...
                            // calculer temp ecouler de chaque action ///////////////////////////////////////
                            // startDate = action.dd;
                            // endDate = action.df;
                            // currentDate = new Date('DD-MM-YYYY');
                            ...
                            //     { 
                            //         currentDuration = currentDate - startDate;
