...
<body id="page-top">
                    ...
                    <div class="row p-4 py-5 justify-content-center align-items-center" >
                        ...
                        <div class="col-9 d-flex justify-content-center align-items-center p-0" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 30px 90px; width: 50vw; height: 80vh; background-color: rgb(255, 255, 255)">
                            ...
                            <div class="col-6 divFormSins justify-content-center align-items-center p-3" style="background-color: rgb(255, 255, 255); max-height: 100%; ">
                                ...
                                <br>
                                <div class="text-center">
                                    <p>Veuillez contacter l'administrateur système s'il vous plait !</p>
                                        <button type="button" class="btn btn-success mr-2" id="notification">
                                            <i data-feather="send" class="feather-icon"></i>
                                        </button>
                                </div>
                                  <!------------------------------ Start Modal Send Notiification ----------------------------------------------------->
                                  <div class="modal fade" id="notificationModal" tabindex="-1" aria-labelledby="notificationModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="notificationModalLabel">Envoyer un message</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form action="{{ route('userblocked.send_message') }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                        <div class="row">
    ...
    const addActionButton = document.getElementById('notification');
