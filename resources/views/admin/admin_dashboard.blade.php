                                    ...
                                    <li>
                                        @foreach ($notifications as $notif)
                                            <a class="nav-link pt-3 text-center text-dark" href="javascript:void(0);">
                                                <div>
                                                    <p class="mb-0"><span class="font-weight-bold text-decoration-underline">Date :</span> 
                                                        <?php echo date('Y-m', strtotime($notif->date)); ?>
                                                    </p>

                                                    <p class="mb-0"><span class="font-weight-bold text-decoration-underline">Utilisateur :</span> 
                                                        {{$notif->user->name}}
                                                    </p>

                                                    <p class="mb-0"><span class="font-weight-bold text-decoration-underline">Direction :</span> 
                                                        {{$notif->direction}}
                                                    </p>

                                                    <p class="mb-0"><span class="font-weight-bold text-decoration-underline">Message :</span> 
                                                        {{$notif->message}}
                                                    </p>
                                                </div>
                                            </a>
                                                                                                            ...
                                                                                                            @foreach($descriptions as $description)
                                                                                                                @if ($act->id_act == $description->id_act)
                                                                                                                    <ul class="list-group list-group-horizontal">
                                                                                                                        ...
                                                                                                                        <li class="list-group-item" style="width: 13%">{{date('d-m-Y H:i', strtotime($description->date))}}</li>
